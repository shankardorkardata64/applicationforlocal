...
<!--<form class="form-inline ml-3">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item d-nonde d-sm-inline-block" style='color:white;'>
        <a href="<?= base_url('admin/profile') ?>" class="nav-link" style='color:white;' ><?= trans('profile') ?></a>
      </li>

      <li class="nav-item d-nodne d-sm-inline-block" style='color:white;'>
        <a href="<?= base_url('admin/auth/logout') ?>" class="nav-link" style='color:white;' ><?= trans('logout') ?></a>
      </li>
