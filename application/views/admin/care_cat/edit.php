...
<?php echo form_open(base_url('admin/care_cat/edit'), 'class="form-horizontal"');  ?> 
...
<div class="form-group">
  <label for="username" class="col-md-12 control-label"><?= trans('status') ?></label>

  <div class="col-md-12">
      <select class="form-control" name="status">
      <option  <?php if($info[0]['status']==1){ echo 'selected'; } ?> value="1">Active</option>
      <option  <?php if($info[0]['status']==0){ echo 'selected'; } ?> value="0">De-Active</option>  
    </select>
  </div>
</div>
