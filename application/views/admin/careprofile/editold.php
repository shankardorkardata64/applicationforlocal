...
<div class="col-md-8">
    ...
    <div class="container"style="max-width: 700px;">
            ...
            <div class="row">
                ...
                <?php echo form_open(base_url('admin/careprofile/edit_option'), 'class="form-inline"');  ?> 
                ...
                --><input type="text"  required name="option[]"  class="form-control" id="email">
...
<div class="form-group">
<div class="col-md-12">
<button id="addRow" type="button" class="btn btn-primary pull-right">Add More Option</button>
    <br>
    <br>
<input type="submit" name="submit" value="<?= trans('update') ?>" class="btn btn-primary pull-right">
</div>
 ...
 <?php echo form_close(); ?>
    ...
    <script type="text/javascript">
        ...
        $("#addRow").click(function () {
            ...
            html += '<label for="email">Option:</label>';
            html += '<input required  type="text" name="option[]" class="form-control" id="email">';
            html += '</div>';
