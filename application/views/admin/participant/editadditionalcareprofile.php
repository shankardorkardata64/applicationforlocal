...
--></div>
 ...
 <option <?php if($i['service_provider']==$cc['id']) {  echo "Selected";  } ?> value='<?=$cc['id']?>'><?=$cc['pname']?></option>
  <?php } ?> 
                  ...
                  <div class="col-md-12">
                  <input type="date" name="plan_review_date" value="<?=$i['plan_review_date']?>" class="form-control" id="lastname" placeholder="">
                  </div>
                  </div>
                  </div>
                  ...
                  <div class="col-md-12">
                  <input type="text" name="assesment_description" value="<?=$i['assesment_description']?>"  class="form-control" id="firstname" placeholder="">
                  </div>
                  </div>
                  </div>
                  ...
                  <div class="col-md-12">
                  <input type="text" name="stratergies" value="<?=$i['stratergies']?>"  class="form-control" id="lastname" placeholder="">
                  </div>
                  </div>
                  </div>
                  ...
                  <select  required name="add_task_for_support_worker" class="form-control">
