...
<h3>My Appointed Decision Maker
                  ...
                  <div class='row'>
                   <div class="col-sm-4">
                   <label for="lastname" class="col-md-12 control-label"><?= trans('induring_poa') ?></label></div>
                   <div class="col-sm-4">
                   <div class="form-group">
                    <div class="col-md-12">
                    <select name="induring_poa" class="form-control">
                        <option value=""><?= trans('please_select') ?></option>
                          ...
                          <option value="2">Office Of Public Guardian</option>
                ...
                $array=array(
                  ...
                  array('label'=>'type','name'=>'atype','type'=>'text','required'=>'requiredd', 'value'=>''),
                );
...
$array=array(
array('free_text'=>$plan_label.'_free_text','label'=>$plan_label,'required'=>'requdired','name'=>$plan_label,'type'=>'select', 'value'=>'0','dropdown'=>$dropdown1,'check_val'=>'id'),
);
echo create_formb($array);
}
?>
...
$array1=array(
array('free_text'=>$plan_label1.'_free_text','label'=>$plan_label1,'required'=>'requdired','name'=>$plan_label1,'type'=>'select', 'value'=>'0','dropdown'=>$dropdown1,'check_val'=>'id'),
);
...
$array=array(
array('label'=>$plan_label1,'required'=>'requdired','name'=>$o['name'],'type'=>'select', 'value'=>'','dropdown'=>$dropdown1,'check_val'=>'id'),
);
echo create_formb($array);
}
?>
