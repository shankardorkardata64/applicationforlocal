...
<option value="<?=$ser['id']?>"><?=$ser['pname']?></option>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        ...
                                        &nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="admin_role_status"
                                            value="0" <?php if(isset($record['admin_role_status'])
                                             && $record['admin_role_status']==0 ){echo 'checked';}?>>
                                            Inactive
                                        </label>
                                    </div>
                                </div>  
