                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" required="required" name="admin_role_title" 
                                    value="<?=isset($record['admin_role_title'])?$record['admin_role_title']:''?>">
                                </div>
                            </div>
...
<!--
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?= trans('service_provider') ?></label>
<?php $service_provider=$this->db->get('service_provider')->result_array(); ?>                                
                                <select name='service_provider' class="form-control">

     <option value=''> Select <?= trans('service_provider') ?> </option>
 <?php foreach($service_provider as $ser){  ?>

<option value="<?=$ser['id']?>"  <?php if($record['service_provider_id']==$ser['id']){ echo "selected"; }?>><?=$ser['pname']?></option>
