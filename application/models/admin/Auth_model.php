...
class Auth_model extends CI_Model{
    ...
    public function password_reset_code_app($reset_code, $user_id){
    	$data = array('password_reset_code_app' => $reset_code);
    	$this->db->where('admin_id', $user_id);
    	$this->db->update('ci_admin', $data);
    }
	...
	public function reset_password_app($id, $new_password){
	    $data = array(
			'password_reset_code_app' => '',
			'password' => $new_password
	    );
